...
for topic, msg, t in q_bag.read_messages(topics=[topic]):
    if msg.header.stamp.to_sec() > start and msg.header.stamp.to_sec() < start+duration:
        q_velocities.append([msg.header.stamp.to_sec() - start, np.linalg.norm([msg.twist.twist.linear.x, msg.twist.twist.linear.y, msg.twist.twist.linear.z])])
for topic, msg, t in f_bag.read_messages(topics=[topic]):
    if msg.header.stamp.to_sec() > start and msg.header.stamp.to_sec() < start+duration:
        f_velocities.append([msg.header.stamp.to_sec() - start, np.linalg.norm([msg.twist.twist.linear.x, msg.twist.twist.linear.y, msg.twist.twist.linear.z])])
for topic, msg, t in h_bag.read_messages(topics=[topic]):
    if msg.header.stamp.to_sec() > start and msg.header.stamp.to_sec() < start+duration:
        h_velocities.append([msg.header.stamp.to_sec() - start, np.linalg.norm([msg.twist.twist.linear.x, msg.twist.twist.linear.y, msg.twist.twist.linear.z])])
for topic, msg, t in c_bag.read_messages(topics=[topic]):
    if msg.header.stamp.to_sec() > start and msg.header.stamp.to_sec() < start+duration:
        c_velocities.append([msg.header.stamp.to_sec() - start, np.linalg.norm([msg.twist.twist.linear.x, msg.twist.twist.linear.y, msg.twist.twist.linear.z])])
for topic, msg, t in w_bag.read_messages(topics=[topic]):
    if msg.header.stamp.to_sec() > start and msg.header.stamp.to_sec() < start+duration:
        w_velocities.append([msg.header.stamp.to_sec() - start, np.linalg.norm([msg.twist.twist.linear.x, msg.twist.twist.linear.y, msg.twist.twist.linear.z])])
# Plot velocities
